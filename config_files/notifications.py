...
if not send_mail:
    to_insert = 'notification_0', 'Email functionality has been disabled by your administrator. Feedback submissions or email notifications are not available'
    notifications.insert(0, to_insert)
